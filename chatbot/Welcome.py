...
st.set_page_config(
    page_title="Diabetes Chatbot Assistant",
    page_icon="🩺",
    layout="wide"
)

st.title("Welcome to the Diabetes Chatbot Assistant 🩺")
...
st.markdown(
    ...
    2.  You can ask about symptoms, diet, exercise, and conditions covered in our knowledge base (currently Diabetes).
    
    **Example Questions:**
    - "What are the symptoms of type 2 diabetes?"
    - "What kind of diet is good for diabetes patients?"
    - "Why should I reduce sugar?"
    ...
    **Disclaimer:** This tool is for informational purposes only. It is not a substitute for professional medical advice. Always consult with a qualified healthcare provider.
    ...
    This is powered by a knowledge base created from publicly available information from the world's leading health organizations. We believe in transparency, and our sources include:
